...
The toolkit includes custom validation rules like `ValidInclude` and `ValidPageSize` for common JSON:API parameters. See [Validation Rules](/docs/api-toolkit/latest/advanced/validation-rules) for the full list.
